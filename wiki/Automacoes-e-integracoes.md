...
|------|---------------------|----------------------------|-----------------------|
| Asana → knowledge | Workflow n8n **Andon** | Agente `andon_asana`, skill `asana-csuite-ingest` | `apps/admin/agents/andon_asana/`, `apps/admin/agents/skills/asana-csuite-ingest/` |
...
| Google Drive / Workspace | Google APIs + skills | `google_workspace_advisor` (agente), skills `google-drive-adventure`, `google-workspace-inspector` | `apps/admin/agents/google_workspace_advisor/`, `apps/admin/agents/skills/google-drive-adventure/`, `apps/admin/agents/skills/google-workspace-inspector/` |
| Benchmarks martech | Web + processos internos | Agentes `benchmark_adventure`, `benchmark_clientes`, `benchmark_conteudo` e suas 9 skills | `apps/admin/agents/benchmark_*/`, `apps/admin/agents/skills/benchmark-*` |
