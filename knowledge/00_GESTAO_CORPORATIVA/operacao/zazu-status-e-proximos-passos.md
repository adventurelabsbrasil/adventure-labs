...
- [ ] Arquivamento em `adv_whatsapp_daily` (se quiser histórico por grupo/data): ver `workflows/n8n/whatsapp_groups_agent/README.md` e endpoint `POST /api/cron/whatsapp-daily`
