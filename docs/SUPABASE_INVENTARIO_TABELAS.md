...
- Space (LMS): schema e RLS no repo — migração `clients/01_lidera/lidera-space/supabase/migrations/20260311100000_space_tables_prefix.sql`; doc completa `clients/01_lidera/lidera-space/docs/COMO_FUNCIONA_BANCO_E_ROLES.md`. Aplicado apenas no Supabase do cliente, não neste projeto.
