...
|----------|--------|--------|--------------------|--------|-------|-------------|--------|---------------|-------|
| 1213744799182618 | Asana | Consertar campanha Google Ads [Rose] | P0 | todo | Lead Vibe-Coder | | 2026-03-21 10:00 | 2026-03-22 | CID Rose `1677226456` — já em `GOOGLE_ADS_CONTAS_REGISTRO.md`. Sem impressões: checklist diagnóstico no mesmo doc; validar no painel Google Ads + Infisical `GOOGLE_ADS_*`. |
