...
| [knowledge/00_GESTAO_CORPORATIVA/processos/n8n-railway-e-admin.md](../../../knowledge/00_GESTAO_CORPORATIVA/processos/n8n-railway-e-admin.md) | n8n (VPS/Coolify) + integração Admin; Railway = arquivo no doc |
