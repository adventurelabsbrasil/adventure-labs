...
- **Admin Adventure Labs:** menu **Benditta (Meta)** → `/dashboard/benditta` (e tabela em `/dashboard/benditta/tabela`). CSV servido em `apps/core/admin/public/benditta/BM-202603-MetaReport.csv`.
