# Email para cliente — Nova feature Exportação de candidatos

**Assunto sugerido (escolha um):**

- **Nova no Young Talents: exporte sua lista de candidatos em CSV, Excel ou PDF**
- **Young Talents — Nova funcionalidade: exportação em CSV, Excel e PDF**
- **Exporte candidatos filtrados direto do Young Talents (CSV, Excel, PDF)**

---

**Arquivo HTML:** use o arquivo `email-cliente-export-candidatos.html` nesta pasta. Abra no navegador para visualizar; depois copie o código-fonte (Ctrl+A no View Source) ou use “Enviar esta página por email” / colar o HTML no seu cliente de email.

**Versão em bloco de código (backup):**
...
<head>
  ...
  <title>Nova funcionalidade — Exportação de candidatos</title>
</head>
  ...
  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width: 560px; margin: 0 auto; background-color: #ffffff;">
    ...
    <tr>
      <td style="padding: 0 40px 32px;">
        ...
        <p style="margin: 0 0 20px; font-size: 15px; color: #334155;">Temos uma novidade na plataforma: agora você pode <strong>exportar a lista de candidatos</strong> que está vendo na tela, nos formatos que preferir.</p>
