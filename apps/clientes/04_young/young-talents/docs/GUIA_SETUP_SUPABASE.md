...
O script lê a lista a partir de `scripts/users-setup.local.json` (cópia local do exemplo; **não** versionar senhas reais). Defina e-mails e senhas fortes só no seu ambiente.
