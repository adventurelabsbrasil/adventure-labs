...
> **Governança (2026-03):** o ATS é **projeto entregue** e sob propriedade da **Young Empreendimentos**. Código histórico no monorepo: **`apps/clientes/young-talents/plataforma`**. Este diretório em `clients/04_young/` mantém espelho de SQL/docs para referência e handoff. Ver [`docs/YOUNG_TALENTS_PROJETO_ENTREGUE.md`](../../../docs/YOUNG_TALENTS_PROJETO_ENTREGUE.md) e [`docs/young-talents/CHANGELOG.md`](../../../docs/young-talents/CHANGELOG.md).
>
> **Supabase (acesso compartilhado):** embora a propriedade do produto seja da Young Empreendimentos, a Adventure Labs mantém acesso compartilhado ao projeto Supabase do Young Talents para suporte técnico, diagnóstico e handoff quando necessário.
>
> **Nota (monorepo):** Modelo de segurança (sem segredos): `wiki/Young-Talents-ATS-Seguranca.md` e `docs/young-talents/sql/README.md` na raiz do monorepo.
