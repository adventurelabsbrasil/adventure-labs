    ...
    return NextResponse.json(
      {
        error: msg,
        hint:
          "Confira NEXT_PUBLIC_SUPABASE_URL e SUPABASE_SERVICE_ROLE_KEY. No monorepo, o arquivo é apps/labs/xpostr/.env.local (não use só a raiz). Na Vercel, defina essas vars no projeto do Xpostr.",
      },
      { status: 500 }
    );
  }
